...
base_model = list(base_models.keys())[0]  # EfficientNetB5
...
def main(_argv):
    ...
    ds_generator = DataGenerator(file_ext=["png", "jpg"], folder_path='data/filter_aug/train')
    test_data = DataGenerator(training=False, file_ext=["png", "jpg"], folder_path='data/filter_aug/test')
    ...
    try:
        tf.keras.utils.plot_model(
            model, to_file=f"assets/{base_model}_model_fig.png", show_shapes=True, expand_nested=True
        )
